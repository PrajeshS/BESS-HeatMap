...
with st.spinner('Calculating sensitivity matrix...'):
    ...
    ax.invert_yaxis() # Standard engineering orientation
    st.pyplot(fig)

st.info("The matrix above updates automatically when you change the sidebar sliders.")
